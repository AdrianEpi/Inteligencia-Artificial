...
* @Last Modified time: 2020-11-14 08:55:23
*/
/*------------------  FUNCTIONS  -----------------*/
 ...
 * @return     The distance.
 */
float HeuristicFunction::calculateDistance (std::pair<unsigned, unsigned>& startLine, std::pair<unsigned, unsigned>& finishLine) {
    return get_Distance();
}
